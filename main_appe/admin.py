...
from .models import Banner,Category,Brand,Color,Size,Product,ProductAttributes,cartorder,cartorderitems,ProductReview,WishList,UserAddressBook
...
class cartorderAdmin(admin.ModelAdmin):
    ...
    list_display = ['user','total_amount','order_dt','paid_status','order_status']
...
admin.site.register(UserAddressBook,UserAddressAdmin)
